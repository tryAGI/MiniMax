...
namespace MiniMax
{
    public partial class VideoClient
    {
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_GetVideoTemplateGenerationTaskSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_GetVideoTemplateGenerationTaskSecurityRequirement0,
            };
        partial void PrepareGetVideoTemplateGenerationTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string taskId);
        partial void PrepareGetVideoTemplateGenerationTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string taskId);
        partial void ProcessGetVideoTemplateGenerationTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVideoTemplateGenerationTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.VideoTemplateTaskStatusResponse> GetVideoTemplateGenerationTaskAsync(
            string taskId,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetVideoTemplateGenerationTaskAsResponseAsync(
                taskId: taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTemplateTaskStatusResponse>> GetVideoTemplateGenerationTaskAsResponseAsync(
            string taskId,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVideoTemplateGenerationTaskArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVideoTemplateGenerationTaskSecurityRequirements,
                operationName: "GetVideoTemplateGenerationTaskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetVideoTemplateGenerationTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetVideoTemplateGenerationTask",
                                methodName: "GetVideoTemplateGenerationTaskAsync",
                                pathTemplate: "\"/v1/query/video_template_generation\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVideoTemplateGenerationTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVideoTemplateGenerationTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.VideoTemplateTaskStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTemplateTaskStatusResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.VideoTemplateTaskStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
