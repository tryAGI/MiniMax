...
namespace MiniMax
{
    public partial class VideoClient
    {
        ...
        private static readonly global::MiniMax.AutoSDKServer[] s_CreateVideoTemplateGenerationTaskServers = new global::MiniMax.AutoSDKServer[]
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement s_CreateVideoTemplateGenerationTaskSecurityRequirement0 =
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_CreateVideoTemplateGenerationTaskSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_CreateVideoTemplateGenerationTaskSecurityRequirement0,
            };
        partial void PrepareCreateVideoTemplateGenerationTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::MiniMax.VideoTemplateGenerationRequest request);
        partial void PrepareCreateVideoTemplateGenerationTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::MiniMax.VideoTemplateGenerationRequest request);
        partial void ProcessCreateVideoTemplateGenerationTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVideoTemplateGenerationTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.VideoTemplateGenerationResponse> CreateVideoTemplateGenerationTaskAsync(

            global::MiniMax.VideoTemplateGenerationRequest request,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVideoTemplateGenerationTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTemplateGenerationResponse>> CreateVideoTemplateGenerationTaskAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVideoTemplateGenerationTaskArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVideoTemplateGenerationTaskSecurityRequirements,
                operationName: "CreateVideoTemplateGenerationTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::MiniMax.PathBuilder(
                                ...
                                servers: s_CreateVideoTemplateGenerationTaskServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVideoTemplateGenerationTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVideoTemplateGenerationTask",
                                methodName: "CreateVideoTemplateGenerationTaskAsync",
                                pathTemplate: "\"/v1/video_template_generation\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVideoTemplateGenerationTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVideoTemplateGenerationTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.VideoTemplateGenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTemplateGenerationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.VideoTemplateGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.VideoTemplateGenerationResponse> CreateVideoTemplateGenerationTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::MiniMax.VideoTemplateGenerationRequest
            {
            ...
            return await CreateVideoTemplateGenerationTaskAsync(
                request: __request,
                requestOptions: requestOptions,
