...
namespace MiniMax
{
    public partial class MusicClient
    {
        ...
        private static readonly global::MiniMax.AutoSDKServer[] s_CreateLyricsGenerationServers = new global::MiniMax.AutoSDKServer[]
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement s_CreateLyricsGenerationSecurityRequirement0 =
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_CreateLyricsGenerationSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_CreateLyricsGenerationSecurityRequirement0,
            };
        partial void PrepareCreateLyricsGenerationArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::MiniMax.LyricsGenerationRequest request);
        partial void PrepareCreateLyricsGenerationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::MiniMax.LyricsGenerationRequest request);
        partial void ProcessCreateLyricsGenerationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateLyricsGenerationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.LyricsGenerationResponse> CreateLyricsGenerationAsync(

            global::MiniMax.LyricsGenerationRequest request,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateLyricsGenerationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.LyricsGenerationResponse>> CreateLyricsGenerationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateLyricsGenerationArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateLyricsGenerationSecurityRequirements,
                operationName: "CreateLyricsGenerationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::MiniMax.PathBuilder(
                                ...
                                servers: s_CreateLyricsGenerationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateLyricsGenerationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateLyricsGeneration",
                                methodName: "CreateLyricsGenerationAsync",
                                pathTemplate: "\"/v1/lyrics_generation\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateLyricsGenerationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateLyricsGenerationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.LyricsGenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.LyricsGenerationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.LyricsGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.LyricsGenerationResponse> CreateLyricsGenerationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::MiniMax.LyricsGenerationRequest
            {
                Mode = mode,
                Prompt = prompt,
                Lyrics = lyrics,
            ...
            return await CreateLyricsGenerationAsync(
                request: __request,
                requestOptions: requestOptions,
