...
namespace MiniMax
{
    public partial class SpeechClient
    {
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_CreateTextToSpeechTaskSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_CreateTextToSpeechTaskSecurityRequirement0,
            };
        partial void PrepareCreateTextToSpeechTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::MiniMax.AsyncTextToSpeechRequest request);
        partial void PrepareCreateTextToSpeechTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::MiniMax.AsyncTextToSpeechRequest request);
        partial void ProcessCreateTextToSpeechTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTextToSpeechTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.AsyncTextToSpeechTaskResponse> CreateTextToSpeechTaskAsync(

            global::MiniMax.AsyncTextToSpeechRequest request,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTextToSpeechTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.AsyncTextToSpeechTaskResponse>> CreateTextToSpeechTaskAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTextToSpeechTaskArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTextToSpeechTaskSecurityRequirements,
                operationName: "CreateTextToSpeechTaskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTextToSpeechTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTextToSpeechTask",
                                methodName: "CreateTextToSpeechTaskAsync",
                                pathTemplate: "\"/v1/t2a_async_v2\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTextToSpeechTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTextToSpeechTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.AsyncTextToSpeechTaskResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.AsyncTextToSpeechTaskResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.AsyncTextToSpeechTaskResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.AsyncTextToSpeechTaskResponse> CreateTextToSpeechTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::MiniMax.AsyncTextToSpeechRequest
            {
                Model = model,
                Text = text,
            ...
            return await CreateTextToSpeechTaskAsync(
                request: __request,
                requestOptions: requestOptions,
