...
namespace MiniMax
{
    public partial class MusicClient
    {
        ...
        private static readonly global::MiniMax.AutoSDKServer[] s_CreateMusicCoverPreprocessServers = new global::MiniMax.AutoSDKServer[]
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement s_CreateMusicCoverPreprocessSecurityRequirement0 =
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_CreateMusicCoverPreprocessSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_CreateMusicCoverPreprocessSecurityRequirement0,
            };
        partial void PrepareCreateMusicCoverPreprocessArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::MiniMax.MusicCoverPreprocessRequest request);
        partial void PrepareCreateMusicCoverPreprocessRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::MiniMax.MusicCoverPreprocessRequest request);
        partial void ProcessCreateMusicCoverPreprocessResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateMusicCoverPreprocessResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.MusicCoverPreprocessResponse> CreateMusicCoverPreprocessAsync(

            global::MiniMax.MusicCoverPreprocessRequest request,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateMusicCoverPreprocessAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.MusicCoverPreprocessResponse>> CreateMusicCoverPreprocessAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateMusicCoverPreprocessArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateMusicCoverPreprocessSecurityRequirements,
                operationName: "CreateMusicCoverPreprocessAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::MiniMax.PathBuilder(
                                ...
                                servers: s_CreateMusicCoverPreprocessServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateMusicCoverPreprocessRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateMusicCoverPreprocess",
                                methodName: "CreateMusicCoverPreprocessAsync",
                                pathTemplate: "\"/v1/music_cover_preprocess\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateMusicCoverPreprocessResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateMusicCoverPreprocessResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.MusicCoverPreprocessResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.MusicCoverPreprocessResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.MusicCoverPreprocessResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.MusicCoverPreprocessResponse> CreateMusicCoverPreprocessAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::MiniMax.MusicCoverPreprocessRequest
            {
                Model = model,
                AudioUrl = audioUrl,
            ...
            return await CreateMusicCoverPreprocessAsync(
                request: __request,
                requestOptions: requestOptions,
