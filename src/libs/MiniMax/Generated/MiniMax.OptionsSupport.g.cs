...
namespace MiniMax
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::MiniMax.AutoSDKRetryOptions Retry { get; set; } = new global::MiniMax.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::MiniMax.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::MiniMax.IAutoSDKHook>();
        ...
        public global::MiniMax.AutoSDKClientOptions AddHook(
            global::MiniMax.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::MiniMax.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::MiniMax.AutoSDKClientOptions UseAuthorizationProvider(
            global::MiniMax.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::MiniMax.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::MiniMax.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::MiniMax.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::MiniMax.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::MiniMax.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::MiniMax.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::MiniMax.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::MiniMax.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::MiniMax.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::MiniMax.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::MiniMax.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::MiniMax.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::MiniMax.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::MiniMax.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::MiniMax.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::MiniMax.AutoSDKClientOptions clientOptions,
            global::System.Func<global::MiniMax.IAutoSDKHook, global::MiniMax.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::MiniMax.AutoSDKHookContext context)
        {
