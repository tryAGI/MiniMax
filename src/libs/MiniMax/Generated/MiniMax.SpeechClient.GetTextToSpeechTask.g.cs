...
namespace MiniMax
{
    public partial class SpeechClient
    {
        ...
        private static readonly global::MiniMax.AutoSDKServer[] s_GetTextToSpeechTaskServers = new global::MiniMax.AutoSDKServer[]
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement s_GetTextToSpeechTaskSecurityRequirement0 =
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_GetTextToSpeechTaskSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_GetTextToSpeechTaskSecurityRequirement0,
            };
        partial void PrepareGetTextToSpeechTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long taskId);
        partial void PrepareGetTextToSpeechTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long taskId);
        partial void ProcessGetTextToSpeechTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTextToSpeechTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.AsyncTextToSpeechTaskStatusResponse> GetTextToSpeechTaskAsync(
            long taskId,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTextToSpeechTaskAsResponseAsync(
                taskId: taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.AsyncTextToSpeechTaskStatusResponse>> GetTextToSpeechTaskAsResponseAsync(
            long taskId,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTextToSpeechTaskArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTextToSpeechTaskSecurityRequirements,
                operationName: "GetTextToSpeechTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::MiniMax.PathBuilder(
                                ...
                                servers: s_GetTextToSpeechTaskServers,
                                defaultBaseUrl: "https://api.minimax.io/"));
                            __pathBuilder
                                .AddRequiredParameter("task_id", taskId.ToString()!)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTextToSpeechTaskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTextToSpeechTask",
                                methodName: "GetTextToSpeechTaskAsync",
                                pathTemplate: "\"/v1/query/t2a_async_query_v2\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTextToSpeechTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTextToSpeechTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.AsyncTextToSpeechTaskStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.AsyncTextToSpeechTaskStatusResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.AsyncTextToSpeechTaskStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
