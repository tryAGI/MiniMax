...
namespace MiniMax
{
    public partial class VideoClient
    {
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_GetVideoGenerationTaskSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
            {                s_GetVideoGenerationTaskSecurityRequirement0,
            };
        partial void PrepareGetVideoGenerationTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string taskId);
        partial void PrepareGetVideoGenerationTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string taskId);
        partial void ProcessGetVideoGenerationTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVideoGenerationTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.VideoTaskStatusResponse> GetVideoGenerationTaskAsync(
            string taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTaskStatusResponse>> GetVideoGenerationTaskAsResponseAsync(
            string taskId,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVideoGenerationTaskArguments(
            ...
            var __authorizations = global::MiniMax.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVideoGenerationTaskSecurityRequirements,
                operationName: "GetVideoGenerationTaskAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetVideoGenerationTaskAsync",
                                pathTemplate: "\"/v1/query/video_generation\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVideoGenerationTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVideoGenerationTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.VideoTaskStatusResponse>(
