...
namespace MiniMax
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::MiniMax.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::MiniMax.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::MiniMax.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::MiniMax.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::MiniMax.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::MiniMax.ApiException exception)
        ...
        private static global::MiniMax.AutoSDKRequestOptions CloneRequestOptions(
            global::MiniMax.AutoSDKRequestOptions? source)
        {
            var clone = new global::MiniMax.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
