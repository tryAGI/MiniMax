...
namespace MiniMax
{
    public partial class ImageClient
    {
        ...
        private static readonly global::MiniMax.AutoSDKServer[] s_CreateImageGenerationServers = new global::MiniMax.AutoSDKServer[]
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement s_CreateImageGenerationSecurityRequirement0 =
        ...
        private static readonly global::MiniMax.EndPointSecurityRequirement[] s_CreateImageGenerationSecurityRequirements =
            new global::MiniMax.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.ImageGenerationResponse> CreateImageGenerationAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::MiniMax.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::MiniMax.AutoSDKHttpResponse<global::MiniMax.ImageGenerationResponse>> CreateImageGenerationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::MiniMax.PathBuilder(
                                ...
                                servers: s_CreateImageGenerationServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::MiniMax.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "\"/v1/image_generation\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::MiniMax.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::MiniMax.ImageGenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::MiniMax.AutoSDKHttpResponse<global::MiniMax.ImageGenerationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::MiniMax.ImageGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::MiniMax.ImageGenerationResponse> CreateImageGenerationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::MiniMax.ImageGenerationRequest
            {
                Model = model,
                Prompt = prompt,
